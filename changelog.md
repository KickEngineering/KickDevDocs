...
* The existing [Token introspect endpoint](apis/users.md) is now deprecated, the [new endpoint](getting-started/generating-tokens-oauth2-flow.md#token-introspect-endpoint) has moved under `/oauth` instead of `/public`&#x20;
